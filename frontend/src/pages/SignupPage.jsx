...
export default function SignupPage({ onSignup }) {
	...
	const submit = async (e) => {
		...
		try {
			...
			const errorMsg = err.response?.data?.message || err.message || 'Signup failed. Please check your information and try again.'
			setError(errorMsg)
		} finally {
			setLoading(false)
		}
		...
		<div className="auth-container">
			<div className="auth-card">
				<div className="auth-header">
					...
					<p className="auth-subtitle">Join us to start booking EV charging ports</p>
				</div>
				...
				<div className="auth-footer">
					...
					<Link className="auth-link" to="/login">Sign in instead</Link>
				</div>
			</div>
		</div>
	)
